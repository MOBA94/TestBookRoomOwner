...
namespace MAPMAServiceLayers.CusRef {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(MAPMAServiceLayers.CusRef.Customer))]
    ...
    [System.SerializableAttribute()]
    public partial class Customer : MAPMAServiceLayers.CusRef.Person {
    ...
    public interface ICustomerServices {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://localhost:8737/Design_Time_Addresses/Customer/ICustomerServices/Get", ReplyAction="http://localhost:8737/Design_Time_Addresses/Customer/ICustomerServices/GetRespons" +
            "e")]
        MAPMAServiceLayers.CusRef.Customer Get(string username);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://localhost:8737/Design_Time_Addresses/Customer/ICustomerServices/Get", ReplyAction="http://localhost:8737/Design_Time_Addresses/Customer/ICustomerServices/GetRespons" +
            "e")]
        System.Threading.Tasks.Task<MAPMAServiceLayers.CusRef.Customer> GetAsync(string username);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICustomerServicesChannel : MAPMAServiceLayers.CusRef.ICustomerServices, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CustomerServicesClient : System.ServiceModel.ClientBase<MAPMAServiceLayers.CusRef.ICustomerServices>, MAPMAServiceLayers.CusRef.ICustomerServices {
        ...
        public MAPMAServiceLayers.CusRef.Customer Get(string username) {
            return base.Channel.Get(username);
        }
        
        public System.Threading.Tasks.Task<MAPMAServiceLayers.CusRef.Customer> GetAsync(string username) {
